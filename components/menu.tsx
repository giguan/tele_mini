...
const Menu = () => {
    ...
    return (
        <footer 
            className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-xl bg-header-footer-gradient flex justify-around items-center z-50 text-xs"
